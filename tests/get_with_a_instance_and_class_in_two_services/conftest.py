...
class Schema(marshmallow.Schema):
    ...
    age = marshmallow.fields.String(required=True)
...
user_info_1 = Service(name='users_1',
                      path='/users-1',
                      validators=(marshmallow_body_validator,),
                      apispec_show=True,
                      apispec_response_schemas=response_schemas_1,
...
response_schemas_2 = {
    200: Schema(exclude=['age']),
}

response_schemas_2[200].__apispec__ = {'model': 'Schema-2'}

user_info_2 = Service(name='users_2',
                      path='/users-2',
                      validators=(marshmallow_body_validator,),
                      apispec_show=True,
                      apispec_response_schemas=response_schemas_2,
                      description='Get and set user data.')
